    ...
    <form id="MembersForm" runat="server">
        <asp:Menu ID="Menu1" runat="server" Orientation="Horizontal" CssClass="tab" StaticMenuItemStyle-CssClass="tabs" StaticHoverStyle-BackColor="#f1f1f1"
            ...
            <Items>
                ...
                <asp:MenuItem NavigateUrl="~/WebPages/Members/MembersPage.aspx" Text="Members" Selected="true" Value="New Item"></asp:MenuItem>
        ...
        <div class="container">
                ...
                <asp:Panel ID="PanelSearch" runat="server" DefaultButton="ButtonSearch">
                    <table class="search-box">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="tbSearchEmpID" runat="server" MaxLength="50" CssClass="input-small" placeholder="Empolyee Number..."></asp:TextBox></td>

                            <td>
                                <asp:Label ID="lblSearchName" runat="server" Text="Employee Name"></asp:Label></td>
                            <td>
                                <asp:TextBox ID="tbSearchName" runat="server" MaxLength="50" CssClass="input-small" placeholder="Name..."></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
            ...
            <div class="scrollable2">
                <asp:GridView CssClass="myGridClass scroll-table" AlternatingRowStyle-CssClass="myAltRowClass" PagerStyle-CssClass="myPagerClass" ID="gvMembers" runat="server" AutoGenerateColumns="False" DataKeyNames="EmployeeNumber" OnRowCommand="gvMembers_RowCommand" OnRowEditing="gvMembers_RowEditing" OnRowUpdating="gvMembers_RowUpdating" OnRowCancelingEdit="gvMembers_RowCancelingEdit" OnRowDataBound="gvMembers_RowDataBound">
                    <Columns>
